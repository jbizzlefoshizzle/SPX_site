...
function buildPlot(stock) {
  // Remember to make an API-key file later
  var apiKey = "LByVdWFyFygff6ocPhFy";

  var url = `https://www.quandl.com/api/v3/datasets/WIKI/${stock}.json?start_date=2016-10-01&end_date=2019-09-01&api_key=${apiKey}`;
